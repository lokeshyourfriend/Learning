...
namespace Learning\CustomFormIntegrationTest\Test\Unit\Controller\Index;

use Learning\CustomForm\Controller\Index\Index;
...
class IndexTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->controller = (new ObjectManagerHelper($this))->getObject(Index::class, [
            'context' => $contextMock,
